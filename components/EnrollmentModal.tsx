  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-start justify-center overflow-y-auto p-3 sm:p-4 pt-20 sm:pt-24">
      ...
      <div className="relative w-full max-w-[980px] max-h-[78vh] sm:max-h-[82vh] bg-white rounded-[2rem] shadow-[0_30px_80px_rgba(79,70,229,0.18)] overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-10 duration-500 flex flex-col">
        ...
        <div className="grid md:grid-cols-[0.95fr_1.35fr] h-full overflow-y-auto">
          <div className="hidden md:flex bg-gradient-to-br from-[#4f46e5] via-[#5b53d7] to-[#7c3aed] p-8 lg:p-10 xl:p-12 flex-col justify-between text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="w-12 h-12 bg-white/15 backdrop-blur-md rounded-2xl flex items-center justify-center mb-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.35)]">
                {type === 'internship' ? <Briefcase className="w-6 h-6" /> : type === 'solution' ? <Globe className="w-6 h-6" /> : <Rocket className="w-6 h-6" />}
              </div>
              <h2 className="text-5xl xl:text-[4rem] font-black leading-[0.9] mb-6 tracking-[-0.06em]">AuralithBit<br /><span className="text-indigo-100">Excellence.</span></h2>
              <p className="text-indigo-100/85 text-xl xl:text-2xl font-medium leading-relaxed max-w-[19rem]">
                Empowering technical minds and global businesses with precision engineering.
              </p>
            </div>

            <div className="relative z-10 space-y-6 mt-10">
              <div className="flex items-center gap-3 text-[11px] sm:text-[12px] font-black uppercase tracking-[0.22em] text-indigo-100">
                <div className="w-2 h-2 rounded-full bg-cyan-300 animate-pulse" />
                Applications Open
              </div>
              <div className="space-y-4">
                {content.benefits.map((txt) => (
                  <div key={txt} className="flex items-center gap-3 text-lg font-medium text-white/90">
          ...
          <div className="col-span-full md:col-span-1 bg-[#f5f7fb] p-6 sm:p-8 lg:p-10 xl:p-12 flex flex-col justify-center overflow-y-auto">
            {step === 'form' ? (
              <div className="animate-in fade-in slide-in-from-right-4 duration-500">
                <div className="mb-6 sm:mb-8">
                  <h3 className="text-[2.1rem] sm:text-[2.4rem] font-black text-slate-900 tracking-[-0.04em] leading-none">{content.title}</h3>
                  <p className="text-slate-500 text-sm font-medium mt-2">{content.subtitle}</p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                    <div className="space-y-2">
                      <label className="text-[11px] sm:text-[12px] font-black text-slate-500 uppercase tracking-[0.22em] ml-1">Full Name</label>
                      <div className="relative">
                        ...
                        <input 
                          ...
                          className="w-full pl-12 pr-4 py-4 bg-white border border-slate-200 rounded-2xl shadow-[0_2px_0_rgba(15,23,42,0.02)] focus:outline-none focus:ring-4 focus:ring-indigo-100 focus:border-indigo-400 transition-all text-base font-medium text-slate-700 placeholder:text-slate-400"
                        />
                      </div>
                    </div>
                    <div className="space-y-2">
                      <label className="text-[11px] sm:text-[12px] font-black text-slate-500 uppercase tracking-[0.22em] ml-1">Phone Number</label>
                      <div className="relative">
                  ...
                  <div className="space-y-2">
                    <label className="text-[11px] sm:text-[12px] font-black text-slate-500 uppercase tracking-[0.22em] ml-1">Email Address</label>
                    <div className="relative">
                  ...
                  <div className="space-y-2">
                    <label className="text-[11px] sm:text-[12px] font-black text-slate-500 uppercase tracking-[0.22em] ml-1">{content.selectionLabel}</label>
                    <div className="relative">
                      ...
                      <select 
                        ...
                        className="w-full pl-12 pr-10 py-4 bg-white border border-slate-200 rounded-2xl shadow-[0_2px_0_rgba(15,23,42,0.02)] focus:outline-none focus:ring-4 focus:ring-indigo-100 focus:border-indigo-400 transition-all text-base font-bold text-slate-700 appearance-none"
                      >
                  ...
                  {content.extraLabel && (
                    <div className="space-y-2 animate-in fade-in slide-in-from-top-2">
                      <label className="text-[11px] sm:text-[12px] font-black text-slate-500 uppercase tracking-[0.22em] ml-1">{content.extraLabel}</label>
                      <div className="relative">
                        {type === 'internship' ? (
                  ...
                  <div className="pt-3">
                    <button 
                      ...
                      className="w-full bg-gradient-to-r from-[#4f46e5] via-[#5b53d7] to-[#7c3aed] text-white py-5 rounded-2xl font-black text-2xl flex items-center justify-center gap-3 hover:shadow-[0_18px_40px_rgba(79,70,229,0.28)] transition-all active:scale-[0.99] disabled:opacity-70 group"
                    >
                    ...
                    <p className="text-[10px] sm:text-[11px] text-center text-slate-400 mt-4 font-bold uppercase tracking-[0.3em]">
